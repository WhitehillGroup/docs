...
This part requires a [Discord](https://discord.com) account (13+)
1. Open the door in the roblox explorer
...
Configuring what is logged via the webhook
...
First we will go over the "settings" script
