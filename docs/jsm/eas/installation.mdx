...
SCO v3 automatically disables the `EAS_Active` value after a product has been bought. At this moment of time, the **mainbanks** do not support this feature. This means you will need to place the deactivation fields on scanners for the time being.
...
### Step 3) Monitoring Station & Operator Barcodes {#3}
